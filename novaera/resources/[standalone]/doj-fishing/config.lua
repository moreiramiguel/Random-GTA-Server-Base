...
Config.FishingWaitTime = {minTime = 10000, maxTime = 12000}     -- How long a player will be waiting to fish, during or after casting fishingrod
...
Config.Skillbar = "ps-ui"                             	-- Must choose one of the avalible skillbars ["reload-skillbar","np-skillbar","qb-skillbar"]
