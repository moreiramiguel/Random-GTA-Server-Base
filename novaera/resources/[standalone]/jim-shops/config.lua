...
Config = {
	...
	Products = {
		...
		["weedshop"] = {
			{ name = "marijuana_joint", price = 10, amount = 1000, info = {} },
			{ name = "weapon_poolcue", price = 100, amount = 1000, info = {} },
			{ name = "marijuana_nutrition", price = 20, amount = 1000, info = {} },
			{ name = "marijuana_baggies", price = 2, amount = 1000, info = {} },
			{ name = "marijuana_rollingpapers", price = 2, amount = 1000, info = {} },
			{ name = "marijuana_lighter", price = 2, amount = 1000, info = {} },
		},
		["gearshop"] = {
