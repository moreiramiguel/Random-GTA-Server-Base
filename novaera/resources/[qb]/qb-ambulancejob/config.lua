...
Config.BillCost = 420 -- Price that players are charged for using the hospital check-in system
Config.DeathTime = 300 -- How long the timer is for players to bleed out completely and respawn at the hospital
Config.PainkillerInterval = 69 -- Set the length of time painkillers last (per one)
Config.HealthDamage = 10 -- Minumum damage done to health before checking for injuries
Config.ArmorDamage = 10 -- Minumum damage done to armor before checking for injuries
Config.ForceInjury = 40 -- Maximum amount of damage a player can take before limb damage & effects are forced to occur
Config.AlwaysBleedChance = 80 -- Set the chance out of 100 that if a player is hit with a weapon, that also has a random chance, it will cause bleeding
Config.MessageTimer = 6 -- How long it will take to display limb/bleed message
Config.AIHealTimer = 15 -- How long it will take to be healed after checking in, in seconds
Config.BleedTickRate = 36 -- How much time, in seconds, between bleed ticks
Config.BleedMovementTick = 9 -- How many seconds is taken away from the bleed tick rate if the player is walking, jogging, or sprinting
...
Config.FadeOutTimer = 4 -- How many bleed ticks occur before fadeout happens
Config.BlackoutTimer = 12 -- How many bleed ticks occur before blacking out
...
Config.ArmInjuryTimer = 25 -- How much time, in seconds, do arm injury effects chance occur
...
Config.MajorArmoredBleedChance = 42 -- The chance, in percent, that a player will get a bleed effect when taking heavy damage while wearing armor
