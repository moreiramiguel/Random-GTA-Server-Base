...
function QBCore.Functions.Kick(source, reason, setKickReason, deferrals)
    reason = '\n' .. reason .. '\n🔸 Dirige-te ao discord para mais informações: ' .. QBCore.Config.Server.Discord
...
function QBCore.Functions.IsPlayerBanned(source)
    ...
    if os.time() < result.expire then
        ...
        return true, 'Foste banido do server:\n' .. result.reason .. '\nO teu ban expira ' .. timeTable.day .. '/' .. timeTable.month .. '/' .. timeTable.year .. ' ' .. timeTable.hour .. ':' .. timeTable.min .. '\n'
    else
