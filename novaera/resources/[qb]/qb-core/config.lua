...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = {['cash'] = 500, ['bank'] = 8500, ['crypto'] = 0} -- ['type'] = startamount - Add or remove money types for your server (for ex. ['blackmoney'] = 0), remember once added it will not be removed from the database!
...
QBConfig.Player = {}
QBConfig.Player.MaxWeight = 110000 -- Max weight a player can carry (currently 110kg, written in grams)
...
QBConfig.Player.ThirstRate = 4.0 -- Rate at which thirst goes down.
...
QBConfig.Server.ClosedReason = "Server Fechado" -- Reason message to display when people can't join the server
...
QBConfig.Server.Discord = "https://discord.gg/SVUKu29kX2" -- Discord invite link
